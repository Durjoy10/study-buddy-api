...
exports.CreatePostDto = exports.PostCategory = void 0;
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Category of the post', enum: PostCategory }),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsEnum)(PostCategory),
    __metadata("design:type", String)
], CreatePostDto.prototype, "category", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Tags for the post', required: false }),
